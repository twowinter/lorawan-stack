...
type EndDevice struct {
	...
	PendingMACState *MACState `protobuf:"bytes,26,opt,name=pending_mac_state,json=pendingMacState,proto3" json:"pending_mac_state,omitempty"`
	// Current session of the device. Stored in Network Server and Application Server.
	Session *Session `protobuf:"bytes,27,opt,name=session,proto3" json:"session,omitempty"`
	// Pending session. Stored in Network Server and Application Server until RekeyInd is received.
	PendingSession *Session `protobuf:"bytes,28,opt,name=pending_session,json=pendingSession,proto3" json:"pending_session,omitempty"`
	// Last DevNonce used.
	// This field is only used for devices using LoRaWAN version 1.1 and later.
	// Stored in Join Server.
	LastDevNonce uint32 `protobuf:"varint,29,opt,name=last_dev_nonce,json=lastDevNonce,proto3" json:"last_dev_nonce,omitempty"`
	// Used DevNonces sorted in ascending order.
	// This field is only used for devices using LoRaWAN versions preceding 1.1.
	// Stored in Join Server.
	UsedDevNonces []uint32 `protobuf:"varint,30,rep,packed,name=used_dev_nonces,json=usedDevNonces,proto3" json:"used_dev_nonces,omitempty"`
	// Last JoinNonce/AppNonce(for devices using LoRaWAN versions preceding 1.1) used.
	// Stored in Join Server.
	LastJoinNonce uint32 `protobuf:"varint,31,opt,name=last_join_nonce,json=lastJoinNonce,proto3" json:"last_join_nonce,omitempty"`
	// Last Rejoin counter value used (type 0/2).
	// Stored in Join Server.
	LastRJCount0 uint32 `protobuf:"varint,32,opt,name=last_rj_count_0,json=lastRjCount0,proto3" json:"last_rj_count_0,omitempty"`
	// Last Rejoin counter value used (type 1).
	// Stored in Join Server.
	LastRJCount1 uint32 `protobuf:"varint,33,opt,name=last_rj_count_1,json=lastRjCount1,proto3" json:"last_rj_count_1,omitempty"`
	// Time when last DevStatus MAC command was received.
	// Stored in Network Server.
	LastDevStatusReceivedAt *time.Time `protobuf:"bytes,34,opt,name=last_dev_status_received_at,json=lastDevStatusReceivedAt,proto3,stdtime" json:"last_dev_status_received_at,omitempty"`
	...
	// Stored in Network Server.
	PowerState PowerState `protobuf:"varint,35,opt,name=power_state,json=powerState,proto3,enum=ttn.lorawan.v3.PowerState" json:"power_state,omitempty"`
	...
	// Stored in Network Server.
	BatteryPercentage *types.FloatValue `protobuf:"bytes,36,opt,name=battery_percentage,json=batteryPercentage,proto3" json:"battery_percentage,omitempty"`
	// Demodulation signal-to-noise ratio (dB).
	// Received via the DevStatus MAC command at last_dev_status_received_at.
	// Stored in Network Server.
	DownlinkMargin int32 `protobuf:"varint,37,opt,name=downlink_margin,json=downlinkMargin,proto3" json:"downlink_margin,omitempty"`
	...
	RecentADRUplinks []*UplinkMessage `protobuf:"bytes,38,rep,name=recent_adr_uplinks,json=recentAdrUplinks,proto3" json:"recent_adr_uplinks,omitempty"`
	// Recent uplink messages sorted by time. Stored in Network Server.
	// The number of messages stored may depend on configuration.
	RecentUplinks []*UplinkMessage `protobuf:"bytes,39,rep,name=recent_uplinks,json=recentUplinks,proto3" json:"recent_uplinks,omitempty"`
	// Recent downlink messages sorted by time. Stored in Network Server.
	// The number of messages stored may depend on configuration.
	RecentDownlinks []*DownlinkMessage `protobuf:"bytes,40,rep,name=recent_downlinks,json=recentDownlinks,proto3" json:"recent_downlinks,omitempty"`
	// Queued Application downlink messages. Stored in Application Server,
	// which sets them on the Network Server.
	QueuedApplicationDownlinks []*ApplicationDownlink `protobuf:"bytes,41,rep,name=queued_application_downlinks,json=queuedApplicationDownlinks,proto3" json:"queued_application_downlinks,omitempty"`
	...
	Formatters *MessagePayloadFormatters `protobuf:"bytes,42,opt,name=formatters,proto3" json:"formatters,omitempty"`
	// ID of the provisioner. Stored in Join Server.
	ProvisionerID string `protobuf:"bytes,43,opt,name=provisioner_id,json=provisionerId,proto3" json:"provisioner_id,omitempty"`
	// Vendor-specific provisioning data. Stored in Join Server.
	ProvisioningData     *types.Struct `protobuf:"bytes,44,opt,name=provisioning_data,json=provisioningData,proto3" json:"provisioning_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
var fileDescriptor_a656ee0551c94a80 = []byte{
	...
	,
}
...
func (m *MACSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PingSlotFrequency != nil {
		...
		n10, err := m.PingSlotFrequency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
	...
	if m.ClassCTimeout != nil {
		...
		n11, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.ClassCTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.Rx1Delay != nil {
		...
		n12, err := m.Rx1Delay.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if m.Rx1DataRateOffset != nil {
		...
		n13, err := m.Rx1DataRateOffset.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
	...
	if m.Rx2DataRateIndex != nil {
		...
		n14, err := m.Rx2DataRateIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
	...
	if m.Rx2Frequency != nil {
		...
		n15, err := m.Rx2Frequency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if len(m.FactoryPresetFrequencies) > 0 {
		dAtA17 := make([]byte, len(m.FactoryPresetFrequencies)*10)
		var j16 int
		for _, num := range m.FactoryPresetFrequencies {
			for num >= 1<<7 {
				dAtA17[j16] = uint8(num&0x7f | 0x80)
				num >>= 7
				j16++
			}
	...
	if m.MaxDutyCycle != nil {
		...
		n18, err := m.MaxDutyCycle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	if m.Supports32BitFCnt != nil {
		...
		n19, err := m.Supports32BitFCnt.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.UseADR != nil {
		...
		n20, err := m.UseADR.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
	...
	if m.ADRMargin != nil {
		...
		n21, err := m.ADRMargin.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.ResetsFCnt != nil {
		...
		n22, err := m.ResetsFCnt.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	...
	if m.StatusTimePeriodicity != nil {
		...
		n23, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.StatusTimePeriodicity, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.StatusCountPeriodicity != nil {
		...
		n24, err := m.StatusCountPeriodicity.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
	...
	if m.DesiredRx1Delay != nil {
		...
		n25, err := m.DesiredRx1Delay.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if m.DesiredRx1DataRateOffset != nil {
		...
		n26, err := m.DesiredRx1DataRateOffset.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
	...
	if m.DesiredRx2DataRateIndex != nil {
		...
		n27, err := m.DesiredRx2DataRateIndex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.DesiredRx2Frequency != nil {
		...
		n28, err := m.DesiredRx2Frequency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *MACState) MarshalTo(dAtA []byte) (int, error) {
	...
	n29, err := m.CurrentParameters.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n29
	...
	n30, err := m.DesiredParameters.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n30
	...
	if m.LastConfirmedDownlinkAt != nil {
		...
		n31, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.LastConfirmedDownlinkAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
	...
	if m.PendingApplicationDownlink != nil {
		...
		n32, err := m.PendingApplicationDownlink.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.QueuedJoinAccept != nil {
		...
		n33, err := m.QueuedJoinAccept.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
	...
	if m.PendingJoinRequest != nil {
		...
		n34, err := m.PendingJoinRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *MACState_JoinAccept) MarshalTo(dAtA []byte) (int, error) {
	...
	n36, err := m.Keys.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n36
...
func (m *EndDevice) MarshalTo(dAtA []byte) (int, error) {
	...
	n37, err := m.EndDeviceIdentifiers.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
	...
	n38, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.CreatedAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
	...
	n39, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.UpdatedAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n39
	...
	if m.VersionIDs != nil {
		...
		n40, err := m.VersionIDs.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	...
	if m.RootKeys != nil {
		...
		n42, err := m.RootKeys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
	...
	if m.NetID != nil {
		...
		n43, err := m.NetID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.MACSettings != nil {
		...
		n44, err := m.MACSettings.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.MACState != nil {
		...
		n45, err := m.MACState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
	...
	if m.PendingMACState != nil {
		...
		n46, err := m.PendingMACState.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
	...
	if m.Session != nil {
		...
		n47, err := m.Session.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
	...
	if m.PendingSession != nil {
		...
		n48, err := m.PendingSession.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
	...
	if len(m.UsedDevNonces) > 0 {
		dAtA50 := make([]byte, len(m.UsedDevNonces)*10)
		var j49 int
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintEndDevice(dAtA, i, uint64(j49))
	...
	if m.LastDevStatusReceivedAt != nil {
		...
		n51, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.LastDevStatusReceivedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
	...
	if m.BatteryPercentage != nil {
		...
		n52, err := m.BatteryPercentage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
	...
	if m.Formatters != nil {
		...
		n53, err := m.Formatters.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
	...
	if m.ProvisioningData != nil {
		...
		n54, err := m.ProvisioningData.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *CreateEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n55, err := m.EndDevice.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n55
...
func (m *UpdateEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintEndDevice(dAtA, i, uint64(m.EndDevice.Size()))
	n56, err := m.EndDevice.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n56
	...
	n57, err := m.FieldMask.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n57
...
func (m *GetEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintEndDevice(dAtA, i, uint64(m.EndDeviceIdentifiers.Size()))
	n58, err := m.EndDeviceIdentifiers.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n58
...
func (m *ListEndDevicesRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n60, err := m.ApplicationIdentifiers.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n60
...
func (m *SetEndDeviceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintEndDevice(dAtA, i, uint64(m.EndDevice.Size()))
	n62, err := m.EndDevice.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n62
